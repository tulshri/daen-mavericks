...
data = pd.read_csv('vdh-covid.csv')
...
# output = query({
#     "org": "Accure__demo", 
#     "question": "Can you generate some summary statistics?"
# })
# output

# output = query({
#     "org": "Accure__demo", 
#     "question": f"For the following sample csv dataset: \n {snapshot} \n  can you generate some summary statistics?"
# })
# output
...
output = query({
    "org": "Accure__demo", 
    "question": f"For the following partial dataset \n {snapshot} \n in the csv file, can you answer the following query: {user_input}? Then based on that input: {user_input}, can you generate a python script to extract this information?"
})
output['generated_text']
# python_code = re.findall(r"```(.*?)```", output['generated_text'], re.DOTALL)
# python_code
